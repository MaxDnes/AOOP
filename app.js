...
const TOOLS = [
  ...
  { id: "adapt",    label: "Adapt Lab",       sub: "rename generated code to fit your project", icon: "↦", color: "#39bae6", module: "ADAPT",
    homeTitle: "Make generated code fit your project",
    homeDesc: "Paste a file your other tools generated (it says ExamApp) and your project's name; get it back with the namespaces + class names rewritten so it drops in with no red errors." },
  { id: "errors",   label: "Error Decoder",   sub: "paste a red error → cause + exact fix", icon: "✚", color: "#f07178", module: "ERRORS",
    homeTitle: "It went red → the fix",
    homeDesc: "Offline lookup of the build/runtime errors that actually happen in this stack. Paste the red text, get the plain-English cause, the exact fix, and which file to touch." },
...
const TOOL_TOPICS = (window.LAB_FILES || []).map((f) => ({
  ...
  id: "adapt",
  title: "Adapt Lab · make generated code fit your project",
  cat: "Tools",
  tags: ["adapt", "rename", "namespace", "examapp", "project", "fit", "match"],
  blocks: [],
  _txt: "adapt lab make generated code fit your project rename namespace examapp viewmodels views models x:class xmlns vm using x:datatype starter project rectangleui familymealplannerui circlecodebehind provided instances mealplanner shoppinglistgenerator controls x:name drop in no red errors paste generated reconcile names class name property to instance",
}, {
  id: "errors",
  title: "Error Decoder · paste a red error, get the fix",
  cat: "Tools",
  tags: ["errors", "error", "decoder", "fix", "compiler", "build", "red"],
  blocks: [],
  _txt: "error decoder paste red error build runtime fix cause which file cs0246 cs0103 cs1061 cs8618 cs0234 cs7036 cs0029 cs0102 nu1101 nu1605 type or namespace could not be found does not contain a definition non-nullable nullable missing using observableproperty partial relaycommand generated name invalid thread ui thread dispatcher headless avaloniafact avaloniatestapplication no tests found projectreference service index nuget offline restore nullreferenceexception jsonexception binarysearch collection was modified compiled binding x:datatype canvas.left target framework net9.0",
}, {
  id: "quiz",
