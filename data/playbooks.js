...
blocks: [
  { p: "Both 2025 exams (June + August re-exam) followed the **exact same blueprint**: 4 problems, 100 points total. Expect the same again." },
  { table: { head: ["#", "Type", "Points", "What you do"], rows: [
    ["1", "Written analysis (OOP or SOLID)", "20–25", "Read a console project, write answers in a .txt file. No coding."],
    ["2", "Avalonia MVVM UI", "30", "Wire up ViewModel + bindings in a prepared project. Strictly MVVM."],
    ["3", "Unit testing OR Async", "15–20", "June: write xUnit + headless tests for a Counter app. August: implement async auto-counter."],
    ["4", "JSON + LINQ console", "25–35", "Deserialize JSON, run queries, maybe binary search or save results to JSON."],
  ]}},
  ...
  { gotcha: "The re-exam required a **strict flat submission folder**: exactly 6 files (Problem_1_Submission.txt, Problem_2_MainWindowViewModel.cs, Problem_2_MainWindow.axaml, Problem_3_MainWindowViewModel.cs, Problem_4_Program.cs, Problem_4_Query_Results.json), no bin/ or obj/. Read the submission instructions FIRST and re-read them before handing in. Wrong format costs real points." },
  ...
  { steps: [
    "**0:00–0:10** Unzip, open everything, read ALL problems + submission rules. Decide order.",
    "**Problem 4 first or second** if LINQ is your strength: it is mechanical and high-value (25–35 pts).",
    "**Problem 2 (UI, 30 pts)** deserves the biggest block; do layout first (free points), then bindings, then the advanced part.",
    "**Problem 1 last or in gaps**: it is writing, not coding; you can always produce something. Use the answer templates in this app.",
    "**Final 20 min**: build everything once more, assemble the submission folder, verify file names character by character.",
  ]},
...
blocks: [
  { p: "You get a small working console project (DocumentManager in June, FamilyMealPlanner in August) and answer questions in a provided `.txt`. The code always **mixes genuine good design with at least one planted violation**. Finding the violation is where the marks hide." },
